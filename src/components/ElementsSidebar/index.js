...
class ElementsSidebar extends Component {
    ...
    render(){
        ...
        return (
            <div className={"element-sidebar"+(this.state.geekMode?' geek-mode':'')}>
                <button className="geek-mode-switch material-icons" title="Geek Mode" onClick={this.switchMode.bind(this)}>code</button>
                <div className="element-sidebar-easy">
