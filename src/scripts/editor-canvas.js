...
class EditorCanvas extends HTMLElement {
    ...
    constructor() {
        ...
        this.setCanvasSize = () => {
            const wsDims = this.getBoundingClientRect();
            this.canvas.setWidth(wsDims.width);
            this.canvas.setHeight(wsDims.height);
        }
        ...
        this._shadow.appendChild(this.canvasElement);
        ...
        var red = new fabric.Rect({
            top: 100, left: 0, width: 80, height: 50, fill: 'red', objectCaching: false,
        });
        var blue = new fabric.Rect({
            top: 0, left: 100, width: 50, height: 70, fill: 'blue', objectCaching: false,
        });
        var green = new fabric.Rect({
            top: 100, left: 100, width: 60, height: 60, fill: 'green', objectCaching: false,
        });
