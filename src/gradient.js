...
var isMobile = window.matchMedia("(max-width: 640px)").matches,
	ColorPicker = function(t) {
		...
		var n = function() {
				...
				}]]),console.log(e.joe), e.alpha = $(".js-alpha-color")[0], o()
			},
			i = function(t) {
	...
	Gradient = function(t, e, n, i) {
		...
		o.stops = t, o.type = e, o.angle = n, o.index = i, o.points = [], o.currentPoint, o.colorPicker, o.gradientBackground = $(".js-header")[0], o.gradientToolBackground = $(".js-background")[0], o.stopsDOM = $(".js-stops")[0], o.container = $(".js-drag")[0], o.width = o.container.scrollWidth, o.code = $(".js-code")[0], o.buttonLinear = $(".js-button-linear")[0], o.buttonRadial = $(".js-button-radial")[0], o.swatch = $(".js-swatch")[i];
		var r = function() {
				o.colorPicker = ColorPicker(o), 
                o.anglePicker = AnglePicker(o, o.angle), t.forEach(function(t) {
					var e = Point(o, t);
					o.points.push(e)
			...
			p = function() {
				...
				var t;
				t = "linear-gradient" === o.type ? o.type + "(" + o.angle + "deg, " : o.type + "(circle, ", t += d(), 
	...
	App = function() {
		...
		t.swatches = $(".js-swatch"), t.compat = $(".js-compat")[0], t.gradient = null, window.isCompat = JSON.parse(localStorage.getItem("isCompat")) || !1;
		var e = function() {
